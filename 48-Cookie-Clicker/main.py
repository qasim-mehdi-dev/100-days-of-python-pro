...
print("Looking for cookie consent overlay...")
try:
    cookie_accept = driver.find_element(by=By.CSS_SELECTOR, value="a.cc_btn_accept_all")
    print("Found cookie consent banner, clearing it...")
    cookie_accept.click()
    sleep(2)
except NoSuchElementException:
    print("Cookie consent banner did not appear or was already cleared.")
